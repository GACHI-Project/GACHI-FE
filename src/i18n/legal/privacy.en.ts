const privacyEn = `GACHI Privacy Policy
...
• Access date and time, service usage records, device information, app version, error logs, and diagnostic information
...
• Responding to inquiries, delivering notices, and handling disputes
• Fulfilling obligations under applicable law

3. Retention and Use Period of Personal Information
The Service destroys personal information without delay once the purpose of its collection and use has been achieved. However, information may be retained for the following periods:
...
• When the user has given separate prior consent
• When required by law or in response to a lawful request from a government agency such as an investigative authority
• When urgently necessary to protect the life, body, or property of the user, to the extent permitted by law

5. Outsourcing of Personal Information Processing
The Service may outsource certain personal information processing tasks to external specialists as needed for smooth service provision:
• Operating cloud servers and data storage
• Sending email verification codes
• Sending notification messages or push notifications
• Log analysis and failure monitoring
※ Upon actual service launch, the names of subcontractors and the scope of outsourced work will be finalized and reflected in this policy.

6. Destruction of Personal Information
The Service destroys personal information without delay when it is no longer needed due to expiration of the retention period or achievement of the processing purpose.
• Personal information in electronic file form is deleted using technical methods that prevent recovery or restoration.
• Personal information recorded on paper documents is destroyed by shredding, incineration, or similar methods.

7. User Rights and How to Exercise Them
• Users may review, correct, or delete their personal information at any time.
• Users may withdraw consent to personal information processing at any time by deleting their account.
• Users may request access, correction, deletion, or suspension of processing related to their personal information.

8. Measures to Ensure the Security of Personal Information
The Service implements the following measures to securely manage users' personal information:
• Encrypted storage of important information such as passwords
• Minimizing access rights to personal information
• Security vulnerability inspections and system access controls
• Technical protective measures against hacking, malware, and unauthorized access
• Access log management and establishment of internal management plans
...
• Service name: GACHI
• Privacy inquiries: privacy@gachi.app
• General inquiries: support@gachi.app

12. Changes to the Privacy Policy
This Privacy Policy may be revised in accordance with changes to applicable law, service policies, or operating methods. Revisions will be announced through the in-app notice board or a separate screen.

Supplementary Provision
This Privacy Policy shall take effect on April 15, 2026.`;
